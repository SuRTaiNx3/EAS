...
namespace EAS
{
    public class HotKey : IDisposable
    {
        ...
        {
            if (Key == Key.None && KeyModifiers == KeyModifier.None)
                return "?";
            else if (Key == Key.None && KeyModifiers != KeyModifier.None)
                return String.Join("+", KeyModifiers.GetIndividualFlags());
            else if (Key != Key.None && KeyModifiers == KeyModifier.None)
                return Key.ToString();
            else
                return String.Join("+", KeyModifiers.GetIndividualFlags()) + "+" + Key.ToString();
        }
    }
